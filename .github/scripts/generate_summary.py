#!/usr/bin/env python3
"""
Generate a GitHub Actions Step Summary in Markdown with tabular details.
"""
import hashlib
import os
import re
...
def main():
    try:
        ...
        repository = os.environ.get("GITHUB_REPOSITORY", "rootminusone8004/bongo-budget")
        ...
        lines = [
            "## 🚀 Bongo Budget — Release Build Summary",
            "",
            "### 📋 Build Details",
            "| Property | Value |",
            "| :--- | :--- |",
            ...
            "| **Runner Node.js** | Node.js 24 (Actions v5/v3 native) |",
            "| **Java JDK** | Eclipse Temurin 17 |",
            "| **Target / Min SDK** | API 34 (Android 14) / API 24 (Android 7.0) |",
            "| **Optimization** | R8 Code & Resource Shrinking Enabled |",
        ...
        lines.extend([
            "",
            "---",
            "*Report generated automatically by Bongo Budget Release Pipeline.*",
            ""
        ])
